...
if(isset($_GET)){
    ...
    $pro_meta = get_post_meta($pro_id);
    $pro_users = [];
    foreach($pro_meta['pro_users'] as $k=>$v){
        $this_user = explode('#-user--do-#',$v);
        $pro_users[$this_user[0]] = $this_user[1];
    }
    // echo '<pre>';
    // var_dump($pro_users);
    // var_dump($pro);
    ...
    <div id="myTabContent" class="tab-content">
        ...
        <div class="tab-pane fade in active" id="basics">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="<?php if($pro['post_title']) echo $pro['post_title'] ?>" name="post_title" placeholder="请输入项目名"><br>
                    <input type="hidden" name='this_is_edit' value="<?php echo $pro["ID"] ?>">
                </div>
            </div>
            <div class="form-group">
                <label for="firstname" class="col-sm-2 control-label">摘要</label>
                <div class="col-sm-10">
                    <textarea class="form-control" rows="3" name="excerpt"><?php if($pro['post_excerpt']) echo $pro['post_excerpt'] ?></textarea><br>
                </div>
            </div>
            <div class="form-group">
                <label for="firstname" class="col-sm-2 control-label">项目演示视频网址(优酷)</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="<?php echo $pro_meta['show_url'][0] ?>" name="show_url" placeholder="请输入项目演示视频链接"><br>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="old-pic-tag panel panel-default" style='display:none'>
                        <div class="panel-heading"></div>
                        <div class="panel-body">
                            <input type="file" name="pro_pic_old" value="">
                        </div>
                    </div>
                    <div class="old_pic panel panel-default" style=''>
                        <img class="" src="<?php echo home_url().'/wp-content'.$pro_meta['pro_pic'][0] ?>" alt="" title="双击重新选择">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <table class="table table-condensed">
                            ...
                            <tbody id="pro_partners">
                                ...
                                <tr class="fields" name="partner_tem">
                                    ...
                                    <td class="td-third">
                                        <div class="form-group text optional base_article_team_members_mini_resume"><textarea class="text optional form-control" maxlength="250" name="pro_userdo[]" ><?php echo $pro_users[$current_user->ID] ?></textarea></div>
                                    </td>
                                    <td style="display:none;">
                                ...
                                <?php 
                                    foreach($pro_users as $k=>$v){
                                        if($k == $current_user->ID){continue;}
                                        $this_user = get_user_by('ID',$k);
                                 ?>
                                <tr class="fields" name="partner_tem">
                                    <td style="width:40%" class="td-fir">
                                        
                                        <a href="<?php echo $usercenter_url ?>">
                                                <font style="vertical-align: inherit;" id="<?php echo $k; ?>" name="pro_uname"><?php echo $this_user->user_login; ?></font>
                                                <input type="hidden" name="pro_user[]" value="<?php echo $k; ?>" class="pro_uid">
                                        </a>
                                    </td>
                                    <td style="display:none;">
                                        <div class="form-group select optional base_article_team_members_permission_action">
                                    ...
                                    <td class="td-third">
                                        <div class="form-group text optional base_article_team_members_mini_resume"><textarea class="text optional form-control" maxlength="250" name="pro_userdo[]" ><?php echo $v; ?></textarea></div>
                                    </td>
                                    <td style="display:none;">
                                        <font style="vertical-align: inherit;"></font>
                                    </td>
        ...
        <div class='content' style="display:none"><?php echo $pro['post_content'] ?></div>
        <!-- --------------------附件-------------------- -->
        <div class="tab-pane fade" id="attachments">
            <div class="panel panel-default">
                <div class="panel-heading">代码</div>
                <div class="old-pic-tag panel-body" style="" >
                    <input type="file" name="code_file_old" value="">
                </div>
                <?php if($pro_meta['code_file']){ ?>
                <div class="old_pic panel panel-default" style=''>
                    <img class="" src="<?php echo home_url().'/wp-content'.$pro_meta['code_file'][0] ?>" alt="" title="双击重新选择">
                </div>
                <?php } ?>
            </div>
            <div class="panel panel-default">
                ...
                <div class="old-pic-tag panel-body" style="" >
                    <input type="file" name="diagrams_file_old" value="">
                </div>
                <?php if($pro_meta['diagrams_file']){ ?>
                <div class="old_pic panel panel-default" style=''>
                    <img class="" src="<?php echo home_url().'/wp-content'.$pro_meta['diagrams_file'][0] ?>" alt="" title="双击重新选择">
                </div>
                <?php } ?>
            </div>
            <div class="panel panel-default">
                ...
                <div class="old-pic-tag panel-body" style="">
                    <input type="file" name="cad_file_old" value="">
                </div>
                <?php if($pro_meta['cad_file']){ ?>
                <div class="old_pic panel panel-default" style=''>
                    <img class="" src="<?php echo home_url().'/wp-content'.$pro_meta['cad_file'][0] ?>" alt="" title="双击重新选择">
                </div>
                <?php }?>
            </div>
        </div>
        ...
        <div class="tab-pane fade" id="publish_setting">
            ...
            <div class="radio">
                <label>
                    <input type="radio" name="post_status" <?php if($pro['post_status'] == 'publish') echo 'checked'; ?> value="publish" > <p>公共</p>
                </label>
            </div>
            <div class="radio">
                <label>
                    <input type="radio" name="post_status" <?php if($pro['post_status'] == 'private') echo 'checked'; ?> value="private" > <p>加密(只有自己可见)</p>
                </label>
            </div>
            ...
            <div class="form-group form-inline">
                <input type="text" class="form-control" name="duration" placeholder="请输入时间" value="<?php echo $pro_meta['duration'][0] ?>"><span>　小时</span>
            </div>  
...
<script src=<?php echo ARTICLE_CREATE_URL;?>/js/project-edit.js></script>
<!-- 引入JS函数文件 -->
